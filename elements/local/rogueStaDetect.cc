...
int
RogueStaDetect::initialize (ErrorHandler *) {
...
void RogueStaDetect::run_timer(Timer *) {
...
void RogueStaDetect::cleanup (StationList &l) {
...
void RogueStaDetect::printStations(StationList &l) {
...
RogueStaDetect::station *
RogueStaDetect::lookup(station &chksta, StationList &l) {
	size_t n = 0;
...
void RogueStaDetect::getStats (StationList &l) {
...
void RogueStaDetect::getAverage(station &sta, int samples) {
...
void RogueStaDetect::getBeaconAverage(station &sta, int samples) {
...
void RogueStaDetect::getLongVariance(station &sta, int samples) {
...
void RogueStaDetect::getShortVariance(station &sta, int samples) {
...
void RogueStaDetect::getEWMA(station &sta) {
...
void RogueStaDetect::keepTrack(station &sta){
...
void RogueStaDetect::logOutput(station &sta, StringAccum log) {
...
void
RogueStaDetect::push(int, Packet *p) {
	...
	// Quick check to see if a failed CRC beacon has the same 
	// MAC as something in the list, if so save it.
	...
	/*	// Removed as we no need to look at all frames 	
	switch (type) {								
