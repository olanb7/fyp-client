...
void protobuf_AssignDesc_olans_2ftest_2eproto() {
  protobuf_AddDesc_olans_2ftest_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "olans/test.proto");
  GOOGLE_CHECK(file != NULL);
  Station_descriptor_ = file->message_type(0);
  static const int Station_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Station, id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Station, address_),
  };
  Station_reflection_ =
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_olans_2ftest_2eproto);
}
...
void protobuf_AddDesc_olans_2ftest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020olans/test.proto\022\tClickTest\"&\n\007Station"
    "\022\n\n\002id\030\001 \002(\005\022\017\n\007address\030\002 \001(\tB)\n\024com.exa"
    "mple.tutorialB\021AddressBookProtos", 112);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "olans/test.proto", &protobuf_RegisterTypes);
  Station::default_instance_ = new Station();
  Station::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_olans_2ftest_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_olans_2ftest_2eproto {
  StaticDescriptorInitializer_olans_2ftest_2eproto() {
    protobuf_AddDesc_olans_2ftest_2eproto();
  }
} static_descriptor_initializer_olans_2ftest_2eproto_;


// ===================================================================

const ::std::string Station::_default_address_;
#ifndef _MSC_VER
const int Station::kIdFieldNumber;
const int Station::kAddressFieldNumber;
#endif  // !_MSC_VER
...
const Station& Station::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_olans_2ftest_2eproto();  return *default_instance_;
}
