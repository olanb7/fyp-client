#ifndef CLICK_ROGUESTADETECT_HH
#define CLICK_ROGUESTADETECT_HH
...
class RogueStaDetect : public Element {
...
public:
  ...
  const char *class_name() const	{ return "RogueStaDetect"; }
  ...
  RogueStaDetect::station * lookup(station &, StationList &);
